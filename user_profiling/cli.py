...
from user_profiling.user_profile_daemon import UserProfileDaemon, DaemonConfig
from user_profiling.engines.persona_engine import PersonaEngine
from user_profiling.vega_integration import UserProfileManager, DailyBriefingGenerator
...
def status(db_path: Optional[str] = typer.Option(None, help="Database path")):
    ...
    try:
        ...
        # Check table counts
        from user_profiling.database.user_profile_schema import (
            IdentityCore,
            ContactInfo,
            Calendar,
            EducationProfile,
        ...
        from user_profiling.user_profile_daemon import UnderstandingScoreCalculator
