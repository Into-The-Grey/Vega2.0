"""
llm.py - Enhanced Multi-Provider LLM Integration for Vega2.0

Supports multiple LLM backends with automatic fallbacks:
- Ollama (local models)
- OpenAI API
- Anthropic Claude
- Azure OpenAI
...
class OllamaProvider(BaseLLMProvider):
    ...
    async def generate(self, prompt: str, **kwargs) -> LLMResponse:
        ...
        if not httpx:
            raise LLMBackendError("httpx not available")
