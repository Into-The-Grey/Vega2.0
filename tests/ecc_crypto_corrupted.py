...
from __future__ import annotations
    ...
    ) -> ECCCertificate:m dataclasses import dataclass
...
class ECCManager:
    ...
    def sign_data(self, data: str, key_id: str) -> ECCSignature:
        ...
        return self.sign_data_with_key(data_bytes, key_pair.private_key)

    def sign_data_with_key(self, data: bytes, private_key: str) -> ECCSignature:
    ...
    def verify_signature(self, data: str, signature: ECCSignature) -> bool:
        ...
        data_bytes = data.encode("utf-8") if isinstance(data, str) else data
        return self.verify_signature_bytes(data_bytes, signature, "")
    ...
    def encrypt_message(self, message: str, recipient_key_id: str) -> bytes:
        ...
        return self.encrypt_message_with_key(message_bytes, key_pair.public_key)

    def encrypt_message_with_key(self, message: bytes, public_key: str) -> bytes:
    ...
    def decrypt_message(self, encrypted_data: bytes, key_id: str) -> str:
        ...
        key_pair = self._key_cache[key_id]
        decrypted_bytes = self.decrypt_message_with_key(
    ...
    def generate_certificate(
        self, key_id: str, subject: str, issuer: str = None
    ) -> "ECCCertificate":
    ...
    def derive_shared_secret(self, private_key_id: str, public_key_id: str) -> str:
        ...
        return self.derive_shared_secret_from_keys(private_key, public_key)

    def derive_shared_secret_from_keys(self, private_key: str, public_key: str) -> str:
