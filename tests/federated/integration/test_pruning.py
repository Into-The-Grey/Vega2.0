    ...
    try:
        ...
        for round_num in range(1, total_rounds + 1):
            ...
            if not metrics.get("skipped", False):
                successful_rounds += 1
                print(
                    f"   Round {round_num}: {metrics['average_sparsity']:.3f} sparsity"
                )
        ...
        print("✅ Pruning coordinator completed successfully")
...
async def run_comprehensive_test():
    ...
    test_functions = [
        ("Pruning Configuration", test_pruning_config),
...
if __name__ == "__main__":
    print(
        "⚠️ Comprehensive pruning integration tests require optional Vega federated algorithms;"
        " some imports may be unavailable in a minimalist setup."
    )
