...
class DocumentIntelligenceTestRunner:
    ...
    def run_specific_module(self, module: str) -> Dict[str, Any]:
        ...
        valid_modules = ["base", "understanding", "classification", "workflow", "legal", "technical"]
    ...
    def run_performance_tests(self) -> Dict[str, Any]:
        ...
        args = [
            str(self.test_directory),
            "-v",
            "-k", "performance or load or concurrent",
            "--tb=short",
            "--asyncio-mode=auto"
        ]
    ...
    def run_error_tests(self) -> Dict[str, Any]:
        ...
        args = [
            str(self.test_directory),
            "-v",
            "-k", "error or failure or invalid or timeout",
            "--tb=short",
            "--asyncio-mode=auto"
        ]
...
def main():
    ...
    parser.add_argument(
        "--module", 
        choices=["base", "understanding", "classification", "workflow", "legal", "technical"],
